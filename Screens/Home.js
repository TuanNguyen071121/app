...
const Home = () => {
  ...
  return (
    <Tab.Navigator screenOptions={{ headerShown: false }}>
      <Tab.Screen
        name="HomeComContainer"
        component={HomeComContainer}
        options={{
          tabBarIcon: () => {
            return (
              <Image
        ...
        <Tab.Screen
          ...
          options={{
            tabBarIcon: () => {
              return (
                <Image
                  source={{ uri: user.photoURL ? user.photoURL : avatarAdmin }}
                  style={styles.icon}
                />
              );
            },
        ...
        <Tab.Screen
          ...
          options={{
            tabBarIcon: () => {
              return (
                <Image
                  source={{ uri: user.photoURL ? user.photoURL : avatarUser }}
                  style={styles.icon}
                />
              );
            },
